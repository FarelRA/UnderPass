...
func main() {
  ...
  flag.StringVar(&httpVersionBoth, "http", "auto", "HTTP version for both POST and GET (auto, h2, h2c, h3)")
  flag.StringVar(&cfg.HTTPVersionPOST, "http-post", "", "HTTP version for POST/upload (overrides -http)")
  flag.StringVar(&cfg.HTTPVersionGET, "http-get", "", "HTTP version for GET/download (overrides -http)")
